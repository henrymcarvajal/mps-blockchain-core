...
public class EncryptorAesGcmPassword {
    ...
    public static String encrypt(byte[] pText, String password) throws EncryptionException {
    ...
    public static String decrypt(String cText, String password) throws DecryptionException {
