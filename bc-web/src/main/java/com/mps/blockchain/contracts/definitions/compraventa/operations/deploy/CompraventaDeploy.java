    ...
    public OperationResult execute(Map<String, String> outputs) {
        ...
        try {
            ...
            if (optionalReceipt.isPresent()) {
                ...
                receipt = StringUtils.toString(transactionReceipt);
            }
            ...
            // this code was not operation aware
            contract.setOperationId(contract.getId());
            deployedContractsRepositoryService.create(contract);
            
            outputs.put("contractId", contract.getId().toString());
