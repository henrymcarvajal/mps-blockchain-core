...
public class JpaConverterBlockchainOperationQueueRequest
    ...
    @Override
    public String convertToDatabaseColumn(BlockchainOperationQueueRequest object) {
        try {
    ...
    @Override
    public BlockchainOperationQueueRequest convertToEntityAttribute(String string) {
        try {
            return OBJECT_MAPPER.readValue(string, BlockchainOperationQueueRequest.class);
