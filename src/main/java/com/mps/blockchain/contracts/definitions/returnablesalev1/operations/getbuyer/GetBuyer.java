...
@Component
public class GetBuyer implements ContractOperation {
	...
	private GetBuyerInputParameters inputParameters;

	@Override
	public String getOperationName() {
		return GetBuyer.class.getSimpleName();
	}

	@Override
	public void buildInputs(Map<String, String> inputs) throws MissingInputException {
		inputParameters = GetBuyerInputParameters.build(inputs);
	}
	...
	public void execute(Map<String, Object> outputs) {
		...
		try {
			...
			RemoteCall<String> transaction = returnableSaleV1.buyer();
