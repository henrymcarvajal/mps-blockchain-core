package com.mps.blockchain.operations.implementations.deploy.contracts;
...
public class ReturnableSaleV1 extends Contract {
    ...
    public static UUID CONTRACT_ID = UUID.fromString("ebd1a631-c08d-4294-aebb-3762c39afc90");
    ...
    @Deprecated
    protected ReturnableSaleV1(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
    ...
    @Deprecated
    protected ReturnableSaleV1(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
    ...
    public Flowable<StateChangedEventResponse> stateChangedEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new Function<Log, StateChangedEventResponse>() {
            @Override
            public StateChangedEventResponse apply(Log log) {
    ...
    public RemoteFunctionCall<TransactionReceipt> setDisputeWinner(BigInteger winner, BigInteger _sellerCharges, BigInteger _buyerCharges) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_SETDISPUTEWINNER, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint8(winner), 
                new org.web3j.abi.datatypes.generated.Uint256(_sellerCharges), 
                new org.web3j.abi.datatypes.generated.Uint256(_buyerCharges)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    @Deprecated
    public static ReturnableSaleV1 load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new ReturnableSaleV1(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static ReturnableSaleV1 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new ReturnableSaleV1(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }
    ...
    public static RemoteCall<ReturnableSaleV1> deploy(Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider, String _seller, String _buyer, BigInteger value) {
    ...
    public static RemoteCall<ReturnableSaleV1> deploy(Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider, String _seller, String _buyer, BigInteger value) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, _seller), 
                new org.web3j.abi.datatypes.Address(160, _buyer)));
    ...
    @Deprecated
    public static RemoteCall<ReturnableSaleV1> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, String _seller, String _buyer, BigInteger value) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, _seller), 
                new org.web3j.abi.datatypes.Address(160, _buyer)));
        return deployRemoteCall(ReturnableSaleV1.class, web3j, credentials, gasPrice, gasLimit, BINARY, encodedConstructor, value);
    }

    @Deprecated
    public static RemoteCall<ReturnableSaleV1> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, String _seller, String _buyer, BigInteger value) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, _seller), 
                new org.web3j.abi.datatypes.Address(160, _buyer)));
        return deployRemoteCall(ReturnableSaleV1.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, encodedConstructor, value);
    }
